                ...
                <div class="report<?php echo $report->resolvedState ? " report-resolved" : ""; ?>">
                    <div class="report-left">
                        ...
                        <div class="report-parent">
                            ...
                            <span class="text">
                                Reported by parent:&nbsp;<b><?php echo $report->parentFirstName . " " . $report->parentLastName; ?></b>
                            </span>
                        </div>
                    ...
                    <div class="report-right">
                        ...
                        <div class="report-actions">
                            <a class="mark-report<?php echo $report->resolvedState ? " button-resolved" : ""; ?>" href="<?php echo URLROOT; ?>/admins/incidentResolved/<?php echo $report->incidentID; ?>">
                                <i class="uil uil-check"></i>
                                &nbsp;Mark Resolved
                            </a>
                            <a class="delete-report" href="<?php echo URLROOT; ?>/admins/incidentDelete/<?php echo $report->incidentID; ?>">
