    ...
    <section class="home-reg">
        <div class="form_container">
          ...
          <div class="form login_form">
            <form action="<?php echo URLROOT; ?>/users/ownerRegister" method="POST">
              <h2>Register</h2>
 
              <div class="toggle">
                <a class="toggle-element" href="<?php echo URLROOT; ?>/users/parentRegister/">Parent</a>
                <a class="toggle-element toggle-active" href="<?php echo URLROOT; ?>/users/ownerRegister/">Vehicle Owner</a>
