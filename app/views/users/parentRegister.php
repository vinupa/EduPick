...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/parent-register/style.css">
  ...
  <body>
    <div class="parent-register">
      <header class="header">
        <div class="navbar">
          <div class="navbar-logo-conatiner">
            <img class="logo-image" src="<?php echo URLROOT; ?>/parent-register/logo-image.png" />
      ...
      <div class="toggle-container">
        <img class="toggle-container-rectangle-l" src="<?php echo URLROOT; ?>/parent-register/toggle-container-rectangle-l.png"/>
        <img class="toggle-container-rectangle"src="<?php echo URLROOT; ?>/parent-register/toggle-container-rectangle.png"/>
        <a href="<?php echo URLROOT; ?>/users/ownerRegister">
          <div class="toggle-text">Vehicle Owner</div>
        </a>
        <a href="<?php echo URLROOT; ?>/users/parentRegister">
          <div class="toggle-text2">Parent</div>
        </a>
      ...
      <div class="login-root-container">
        <div class="login-title">Create a Parent Account</div>

        <form class="login-contatiner" action="<?php echo URLROOT; ?>/users/parentRegister/" method="POST">
          <div class="login-container-sub">
            ...
            <div class="form-text-component">
              <label class="form-text" for="nearest_city">Nearest City</label>
              <select class="form-input-container" id="nearest_city" name="nearest_city">
                <!-- <option value="Select Your City">Select City</option> -->
            ...
            <!-- <div class="form-text-component">
              ...
              <input class="form-input-container" type="text" id="address" name="address" placeholder="Address" required>
            </div> -->
            <div class="form-text-component">
            ...
            <button style="color: white" type="submit">Register</button>
          </div>
          <div class="signin-click-container">
            ...
            <p style="color:red"><?php echo $data['city_err']; ?></p>
        ...
        <div class="footer-social-icons-container">
          <div class="facebook">
            <div class="facebook-icon">
              <img class="facebook2" src="<?php echo URLROOT; ?>/parent-register/facebook2.png" />
            </div>
          </div>
          <div class="instagram">
            <div class="instagram-icon">
              <img class="instagram-circle" src="<?php echo URLROOT; ?>/parent-register/instagram-circle.png" />
            </div>
          </div>
          <div class="twitter">
            <div class="twitter-icon">
              <img class="twitter2" src="<?php echo URLROOT; ?>/parent-register/twitter2.png" />
            </div>
          </div>
        </div>
        <div class="footer-right-container">
          <div class="footer-right-text3">
            <div class="bx-bx-phone">
              <img class="phone" src="<?php echo URLROOT; ?>/parent-register/phone.png" />
            </div>
            <div class="h-6">+94112729729</div>
          </div>
          <div class="footer-right-text3">
            <img class="place-marker" src="<?php echo URLROOT; ?>/parent-register/place-marker.png" />
            <div class="h-6">
              35 Reid Ave Colombo 007, <br />Sri Lanka
            </div>
          </div>
          <div class="footer-right-text3">
            <img class="envelope" src="<?php echo URLROOT; ?>/parent-register/envelope.png" />
