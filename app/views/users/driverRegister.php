...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/driver-register/style.css">
  ...
  <body>
    <div class="driver-register">
      <header class="header">
        <div class="navbar">
          <div class="navbar-logo-conatiner">
            <img class="logo-image" src="<?php echo URLROOT; ?>/driver-register/logo-image.png" />
      ...
      <div class="toggle-container">
        <img class="toggle-container-rectangle-l" src="<?php echo URLROOT; ?>/driver-register/toggle-container-rectangle-l.png"/>
        <img class="toggle-container-rectangle"src="<?php echo URLROOT; ?>/driver-register/toggle-container-rectangle.png"/>
        <a href="<?php echo URLROOT; ?>/users/parentRegister/">
          <div class="toggle-text">Parent</div>
        </a>
        <a href="<?php echo URLROOT; ?>/users/driverRegister/">
          <div class="toggle-text2">Driver</div>
        </a>
        <a href="<?php echo URLROOT; ?>/users/ownerRegister/">
          <div class="toggle-text3">Vehicle Owner</div>
        </a>
      </div>

      <div class="login-root-container">
        <div class="login-title">Create a Driver Account</div>
        <form class="login-contatiner" action="<?php echo URLROOT; ?>/users/driverRegister" method="POST">
          <div class="login-container-sub">
            ...
            <div class="form-text-component">
              ...
              <input class="form-input-container" type="text" id="address" name="address" value="<?php echo $data['address']; ?>">
            </div>
            <div class="form-text-component">
          ...
          <div class="signin-click-container">
            <div class="signin-click-container-sub">
              ...
              <div class="login-direct-text">
                ...
                <p style="color:red"><?php echo $data['address_err']; ?></p>
        ...
        <div class="footer-social-icons-container">
          <div class="facebook">
            <div class="facebook-icon">
              <img class="facebook2" src="<?php echo URLROOT; ?>/driver-register/facebook2.png" />
            </div>
          </div>
          <div class="instagram">
            <div class="instagram-icon">
              <img class="instagram-circle" src="<?php echo URLROOT; ?>/driver-register/instagram-circle.png" />
            </div>
          </div>
          <div class="twitter">
            <div class="twitter-icon">
              <img class="twitter2" src="<?php echo URLROOT; ?>/driver-register/twitter2.png" />
            </div>
          </div>
        </div>
        <div class="footer-right-container">
          <div class="footer-right-text3">
            <div class="bx-bx-phone">
              <img class="phone" src="<?php echo URLROOT; ?>/driver-register/phone.png" />
            </div>
            <div class="h-6">+94112729729</div>
          </div>
          <div class="footer-right-text3">
            <img class="place-marker" src="<?php echo URLROOT; ?>/driver-register/place-marker.png" />
            <div class="h-6">
              35 Reid Ave Colombo 007, <br />Sri Lanka
            </div>
          </div>
          <div class="footer-right-text3">
            <img class="envelope" src="<?php echo URLROOT; ?>/driver-register/envelope.png" />
